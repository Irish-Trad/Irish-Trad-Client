  ...
  return (
    ...
    >
      <Page>
        ...
        <div className="flex flex-col justify-center lg:max-w-5xl">
          <p>
            For those more familiar with Tablature than standard music notation
            or ABC notation I have taken a number of tunes from TheSession.org
            and tabbed them out for both GDAE and GDAD.
          </p>
          <p>
            Clicking on each link below will open the file in a .pdf format.
          </p>
          <p>
            If you find these useful in anyway you should visit TheSession.org
            and consider donating to the website. It has stood as a beacon for
            sharing and educating on musicians on traditional irish music for
            many years.
          </p>
          <p>
